...
public class speakersData {
    ...
    public Object[][] provideData() {
        return new Object[][]{
                {new speaker("Burt Bear","Software Engineer","burt@example.com","+1-541-754-3010",
                        "Burt is a Bear. Burt's interests include poetry, dashing space heroes, and lions. Say hello on social media!")},

                {new speaker("Charlie Cheetah","Software Engineer","charlie@example.com","+1-541-754-3010",
